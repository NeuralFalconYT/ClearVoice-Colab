#copied from https://huggingface.co/spaces/alibabasglab/ClearVoice/blob/main/app.py
import torch
...
def main(debug, share):
    ...
    se_demo = gr.Interface(
        ...
        inputs = [
            ...
            gr.Dropdown(
                ["16000 Hz", "48000 Hz"], value="48000 Hz", multiselect=False, info="Choose a sampling rate for your output."
            ),
        ],
        outputs = [
